...
# Not fully saturated, but we might to condiser adding interaction terms for geneder etc.
# in case there are other heterogeneous effects
# We'll need to melt data and restructure so each wine rating its own record
